...
public enum Constant {
	...
	LOGS_PATH("/target/"), // This should be deprecated : Mandar Wadhavekar
        LOGS_DIR("logs"), //Directory to keep log files : Mandar Wadhavekar
        LOG_FILE_NAME("NFTA"), //name of log file : Mandar Wadhavekar
